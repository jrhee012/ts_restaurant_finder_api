...
ValidationsSchema.methods.setExpireDate = function () {
    ...
    if (this.expires_at === undefined) {
        ...
        var expireDate = createdDate.setDate(createdDate.getDate() + 7);
        this.expires_at = new Date(expireDate).toISOString();
    }
};
ValidationsSchema.methods.completeValidation = function () {
    return __awaiter(this, void 0, void 0, function () {
        var vChcek, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    vChcek = this.validated;
                    if (!!vChcek) return [3 /*break*/, 4];
                    this.validated = true;
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
...
mongoose_1.model("Validations", ValidationsSchema);
