...
var OpentableQueryKey;
(function (OpentableQueryKey) {
    OpentableQueryKey["dataTime"] = "dataTime";
    OpentableQueryKey["latitude"] = "latitude";
    OpentableQueryKey["longitude"] = "longitude";
    OpentableQueryKey["metroId"] = "metroId";
    OpentableQueryKey["term"] = "term";
    OpentableQueryKey["includeTicketedAvailability"] = "includeTicketedAvailability";
    OpentableQueryKey["pageType"] = "pageType";
})(OpentableQueryKey || (OpentableQueryKey = {}));
...
var OpenTableClient = /** @class */ (function (_super) {
    __extends(OpenTableClient, _super);
    function OpenTableClient() {
        var _this = _super.call(this) || this;
        _this.baseUrl = "https://www.opentable.com";
        _this.query = undefined;
        return _this;
    }
    OpenTableClient.prototype.setQuery = function (queries) {
        var result = "?";
    ...
    OpenTableClient.prototype.updateQuery = function (key, value) {
        var queries = this.query || "";
        var startIndex = queries.indexOf(key);
        var endIndex = queries.substring(startIndex).indexOf("&") + queries.substring(0, startIndex).length;
        var oldQuery = queries.substring(startIndex, endIndex);
        var queryArr = oldQuery.split("=");
        queryArr[1] = value;
        var newQuery = lodash_1.default.join(queryArr, "=");
        this.query = queries.substring(0, startIndex) + newQuery + queries.substring(endIndex);
    };
    return OpenTableClient;
}(ApiClient));
exports.OpenTableClient = OpenTableClient;
