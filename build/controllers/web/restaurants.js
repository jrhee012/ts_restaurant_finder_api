...
exports.getAll = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                restaurants = _a.sent();
                return [4 /*yield*/, models_1.Restaurants.populate(restaurants, {
                        path: "source_data",
                        model: "Data"
                    })];
            case 3:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, models_1.Restaurants.findById(rest_id)];
            case 2:
                rest = _a.sent();
                if (rest === null) {
            ...
            case 3:
                _a.sent();
                ext_id = rest.source_data[0].ext_id;
                if (!utils_1.redisClient.cacheExists) return [3 /*break*/, 7];
                cacheKey = rest_id;
                return [4 /*yield*/, utils_1.redisClient.get(cacheKey)];
            case 4:
                cache = _a.sent();
                info = cache;
                if (!(cache === null || cache === undefined)) return [3 /*break*/, 6];
                return [4 /*yield*/, api_client.searchOneBusniness(ext_id)];
            case 5:
            ...
            case 7: return [4 /*yield*/, api_client.searchOneBusniness(ext_id)];
            case 8:
                info = _a.sent();
                _a.label = 9;
