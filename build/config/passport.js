...
exports.default = (function (passport) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            return [2 /*return*/, done(undefined, false, req.flash("error", "Incorrect email."))];
                        }
    ...
    passport.use(new FacebookStrategy({
        ...
        callbackURL: config_1.default.FACEBOOK_CALLBACK_URL,
        passReqToCallback: true,
    }, function (req, accessToken, refreshToken, profile, done) {
        return __awaiter(this, void 0, void 0, function () {
            var user, facebookResp, savedUser, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
 ...
 */
exports.isAuthenticated = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
