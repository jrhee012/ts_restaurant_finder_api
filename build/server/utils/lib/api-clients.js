...
var ApiClient = /** @class */ (function () {
    ...
    ApiClient.prototype.setHttpOptions = function (options) {
    ...
    ApiClient.prototype.makeCall = function (httpOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (lodash_1.default.isEmpty(httpOptions)
                            && !lodash_1.default.isEmpty(this.httpOptions)) {
                            console.log("http");
...
var YelpApiClient = /** @class */ (function (_super) {
    ...
    function YelpApiClient(options) {
