...
router.get("/", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log(1);
                return [4 /*yield*/, utils_1.redisClient.get("test")];
            case 1:
                a = _a.sent();
                console.log(2);
                console.log(a);
                utils_1.redisClient.set("test22", "test222");
                return [4 /*yield*/, utils_1.redisClient.get("test22")];
            case 2:
                b = _a.sent();
                console.log(b);
...
router.use(baseUrl + "/data", data_1.default);
